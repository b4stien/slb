...
1. input : 1 Json config file generated by the Configurator. Input is made at line 677.

1. output : 2 CSV files showing the infos we need about those MATs. Output are made at lines 678 and 688 : 
...
""" gets content from a config file and returns it as a dict {extraction type: value, content to look for: value } """
...
""" manages the browser to get the wanted Mats results page in case of serial numbers input"""
...
""" manages the browser to get the wanted Mats results page in case of date input"""  # TO UPDATE IN ORDER TO GIVE ALSO THE FAMILY SERIAL NUMBERS PREFIXES AS AN INPUT 
